...
\vspace{2mm}
These entities could be countries, states, companies, households, individuals, etc.\footnote[frame]{Rich resource: https://ukdataservice.ac.uk/find-data/browse/ \\}
...
## Clustered Standard Errors {#ClusteredSE}
...
Good news: These time-invariant factors can be effectively captured by the state fixed effect $\alpha_i$! \footnotesize [(>>review)](#EntityFEs) \normalsize
...
+ A $20\%$ increase in GDP per capita implies that `Log_GDPPC` increases by approximately $0.20$, so that `Dem_ind` is predicted to increase by approximately $0.20\times0.236 = 0.0472$, or about $1/8$ of the standard deviation in the dataset.
...
<!-- $$ -->
<!-- \widehat{Y} = \hat\beta_0 + \hat\beta_1 ln(X) -->
<!-- $$ -->

<!-- $1\%$ increase in $X$  -->
<!-- $$ -->
<!-- \Delta \widehat{Y} = \hat{\beta}_1 ln(1.01\cdot X) -  \hat{\beta}_1 ln(X) = \hat{\beta}_1 ln(1.01) = 0.009950331\cdot\hat\beta_1 \approx 0.01\cdot\hat{\beta}_1 -->
<!-- $$ -->

<!-- $20\%$ increase in $X$ -->
<!-- $$ -->
<!-- \Delta \widehat{Y} = \hat{\beta}_1 ln(1.2\cdot X) -  \hat{\beta}_1 ln(X) = \hat{\beta}_1 ln(1.2) = 0.1823216\cdot\hat{\beta}_1 {\color{red}{\overset{???}{\approx}}} 0.20 \cdot \hat{\beta}_1 -->
<!-- $$ -->

<!-- $\hat{\beta}_1 = 0.236 \Rightarrow \Delta \widehat{Y} = 0.0430279 {\color{red}{\overset{???}{\approx}}} 0.0472$  -->

## (b-iii) Why is it important to use clustered standard errors \quad for the regression? 

Compare two models with vs without clustered standard errors \footnotesize [(>>review)](#ClusteredSE) \normalsize
